 ...
 * /api/todos:
 *   get:
 *     summary: Mengambil daftar todo milik user yang sedang login (dengan pagination & search)
 *     tags: [Todos]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: string
 *         description: Fitur pencarian todo berdasarkan judul (misal ?search=judul)
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
